...
-- save-state 2026-07-03T20:50-04:00
-- ====================================================================
...
GRANT SELECT ON ALL TABLES IN SCHEMA audit, admin, content, kb TO auditor;
...
GRANT USAGE ON SCHEMA audit, content, kb, app TO admin;
